...
////////////////////////////////////
		...
		zim.centerReg(aboutDanzen, aboutBacking, false);
		aboutDanzen.y -= 100;

		var aboutDanzenLab = new zim.Label("danzen.com",70,null,"#DDD");
		aboutContent.addChild(aboutDanzenLab);
		zim.centerReg(aboutDanzenLab, aboutBacking, false);
...
////////////////////////////////////
		...
		zim.centerReg(menuDeck, menuBacking, false);
		menuDeck.y += 50;
...
////////////////////////////////////
		...
		v.resultUpdate = function() {
			...
			zim.centerReg(resultLab, resultContent, false);
			resultLab.x-=4;
			resultEcho.removeAllChildren();
			multiplyText(resultLab, resultEcho, m.score+1);
			zim.centerReg(resultEcho, resultContent, false);
			resultEcho.x-=4;
		}
